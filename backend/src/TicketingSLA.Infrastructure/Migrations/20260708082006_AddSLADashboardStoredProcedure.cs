...
{
    public partial class AddSLADashboardStoredProcedure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
CREATE PROCEDURE dbo.GetSLADashboardSummary
...
BEGIN
    ...
    SELECT
        ...
        AVG(CASE 
            WHEN t.Status = 'Closed' 
            THEN DATEDIFF(MINUTE, t.CreatedAt, t.SlaDeadline) 
...
");
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE dbo.GetSLADashboardSummary;");
        }
    }
}